...
def SourceBrowse(): 
    root.files_list = list(filedialog.askopenfilenames(initialdir = "C:\Users\Pelon)
    root.sourceText.insert('1', root.files_list)""
    
def DestinationBrowse(): 
    destinationdirectory = filedialog.askdirectory(initialdir ='C:\Users\Pelon)
